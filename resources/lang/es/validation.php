...
return [
    ...
    | la clase de validador. Algunas de estas reglas tienen múltiples versiones, como las reglas de tamaño.
    | No dudes en modificar cada uno de estos mensajes aquí.
    |
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'El dado :attribute ha aparecido en una filtración de datos. Por favor elige un diferente :attribute.',
    ],
    ...
    | convención "attribute.rule" para nombrar las líneas. Esto facilita especificar rápidamente
    | una línea de idioma personalizada específica para una regla dada de un atributo.
    |
    */
